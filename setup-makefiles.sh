...
#mkdir -p ../../../vendor/motorola/morrison/overlay/packages/apps/Launcher2/res/layout
#(cat << EOF) | sed s/__DEVICE__/$DEVICE/g > ../../../vendor/motorola/morrison/overlay/packages/apps/Launcher2/res/layout/all_apps.xml
